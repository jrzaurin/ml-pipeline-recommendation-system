...
aws s3 cp data/processed/amazon/ s3://recsys-2/data/processed/amazon/ --recursive

aws s3 cp s3://recsys-2/data/processed/amazon/ data/processed/amazon/  --recursive
aws s3 cp s3://recsys-2/data/raw/amazon/ data/raw/amazon/  --recursive
