...
from gmf import GMF, checkpoint, evaluate, train
from mlp import MLP
...
def parse_args():
    ...
    # dirnames
    parser.add_argument(
        "--datadir", type=str, default="../datasets/Amazon", help="data directory."
    )
    parser.add_argument(
        "--modeldir",
        type=str,
        default="../datasets/Amazon/models",
        help="models directory",
    )
    parser.add_argument(
        "--dataname",
        type=str,
        default="neuralcf_split.npz",
        help="npz file with dataset",
    )
    parser.add_argument(
        "--train_matrix",
        type=str,
        default="neuralcf_train_sparse.npz",
    ...
    # GMF set up
    parser.add_argument(
        "--n_emb", type=int, default=8, help="embedding size for the GMF part."
    )
...
if __name__ == "__main__":
    ...
    if learner.lower() == "adagrad":
        ...
        optimizer = torch.optim.RMSprop(
            model.parameters(), lr=lr, weight_decay=l2reg, momentum=0.9
        )
